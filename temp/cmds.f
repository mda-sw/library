C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++C
C                                                                         C
C  Carry out a PRINCIPAL COORDINATES ANALYSIS                             C
C              (CLASSICAL MULTIDIMENSIONAL SCALING).                      C
C                                                                         C
C  To call:   CALL PCA(N,A,IPRINT,W1,W2,A2,IERR)    where                 C
C                                                                         C
C                                                                         C
C  N     : integer number of objects.                                     C
C  A     : input distances array, real, of dimensions N by N.             C
C          On output, A contains in the first 7 columns the projections   C
C          of the objects on the first 7 principal components.            C
C  IPRINT: print options.                                                 C
C          = 3: full printing of items calculated.                        C
C          = 2: printing of everything except the input distance matrix.  C
C          Otherwise: no printing.                                        C
...
C                                                                         C
C                                                                         C
C  Inputs here are N, A, IPRINT (and IERR).                               C
C  Output information is contained in A, and W1.                          C
...
C  Ignore first (trivial) eigenvalue.                                     C
C                                                                         C
C-------------------------------------------------------------------------C
...
C         Ignore first (trivial) eigenvector.                             C
C                                                                         C
C-------------------------------------------------------------------------C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++C
C                                                                         C
C  Output projections of objects on first 7 principal components.         C
C                                                                         C
C-------------------------------------------------------------------------C
...
C+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++C
C                                                                         C
C  Determine projections of objects on 7 principal components.            C
C  Ignore first (trivial) axis.                                           C
C                                                                         C
C-------------------------------------------------------------------------C

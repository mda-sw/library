# Updated from correspondances/hcluswtd.r 2006/4/17, FM, to 
# handle complete link
...
#  UPDATE FOR COMPLETE LINK, FM 2006-4-17
#              adiss[i1,i2] <- adiss[i1,i2] + (wt[i1]*wt[i2])/(wt[i1]+wt[i2]) *
#                    (a[i1,j]-a[i2,j])^2
               adiss[i1,i2] <- adiss[i1,i2] + (a[i1,j]-a[i2,j])^2
           }
